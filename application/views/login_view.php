...
<html lang="fr">
  ...
  <body background="<?php echo base_url('image255111.png'); ?>"></br></br>
  <!-- <body background="<?php //echo base_url('login4.png'); ?>"></br></br> -->
      <div class="container" style="margin-top:100px; margin-left: -10px;" background-image="<?php //echo base_url('image_login.jpg'); ?>">
        <div class="row">
          ...
          <div align="center" class="login-logo"><img src="<?php echo base_url('logo23.png'); ?>" border="0" ALT="Google" align="absmiddle" /></div> 
            ...
            <label><input type="checkbox" name="remember"> Se rappeler de moi</label>
                  ...
                  <button type="submit" style="background-color:#FFCD59; color:#FFFFFF" class="btn btn-lg btn-block">Connexion</button>
                  &nbsp;&nbsp;

...
if (!defined('PDF_HEADER_LOGO')) {
	...
	if (@file_exists(K_PATH_IMAGES.'getrans_logo.png')) {
		$tcpdf_header_logo = 'getrans_logo.png';
	}
	/*if (@file_exists(K_PATH_IMAGES.'stia_logo1.png')) {
		$tcpdf_header_logo = 'stia_logo1.png';
	}*/
